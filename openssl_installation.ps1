...
$globalVars = @{
    ...
    defaultOrganization = "McGee ECM Solutions, LLC."; # THESE MUST MATCH FOR THE ROOT TO SIGN THE INTERMEDAITE CERTIFICATE.
    defaultEmail = "first.last@mcgeeecmsolutions.com";
    defaultState = "Kansas";
